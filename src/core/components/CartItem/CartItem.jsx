    ...
    <div className="flex p-5 max-w-[800px]">
      ...
      <div className="grid grid-cols-2 items-center justify-items-between w-full sm:flex sm:items-center sm:justify-between">
        ...
        <div className="flex flex-col">
          ...
          <button type="button" className="flex items-center justify-center w-full font-medium rounded-full text-sm text-center bg-gray-100 hover:bg-gray-200 focus:ring focus:outline-none focus:ring-gray-300 py-2">
