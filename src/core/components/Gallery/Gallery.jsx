...
const Gallery = () => {
  ...
  const projects = [
    ...
    { id: 4, title: 'Campana #4', description: 'Descripción detallada del proyecto Campana #4 mostrando su impacto y valor.', imageUrl: '/src/assets/img/fondoCampana.png' },
  ...
  const styles = {
    container: {
      minHeight: '100vh',
      backgroundColor: 'rgba(184, 115, 51, 0.9)',
      display: 'flex',
